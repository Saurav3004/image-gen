...
-- CreateEnum
CREATE TYPE "EthinicityEnum" AS ENUM ('White', 'Black', 'EastAsian', 'AsianAmerican', 'SouthEastAsian', 'SouthAsian', 'MiddleEastern', 'Pacific', 'Hispanic');

-- CreateEnum
CREATE TYPE "EyeColorEnum" AS ENUM ('Blue', 'Brown', 'Hazle', 'Green');
